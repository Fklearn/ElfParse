...
/**
 * Generic exception class for all exceptions which occur in this package. Since there is no mechanism built into this
 * library for recovering from errors, the best clients can do is display the error string.
 */

public class ELFException extends RuntimeException {
    private static final long serialVersionUID = -8337193513979156091L;
